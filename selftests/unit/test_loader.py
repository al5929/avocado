...
class LoaderTest(unittest.TestCase):
    ...
    def test_load_foreign(self):
        ...
        test_class, _ = (
            self.loader.discover(avocado_pass_test.path,
    ...
    def test_load_multiple_imports(self):
        ...
        test_class, _ = (
            self.loader.discover(avocado_multiple_imp_test.path,
                loader.DiscoverMode.ALL)[0])
    ...
    def test_list_raising_exception(self):
        with script.TemporaryScript('test.py',
            AVOCADO_TEST_OK) as avocado_test:
            with unittest.mock.patch(
                'avocado.core.loader.safeloader.find_avocado_tests') as _mock:
